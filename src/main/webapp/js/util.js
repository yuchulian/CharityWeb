...
Util.prototype = {
	temp : {
		...
		selectImgHTML : '<div class="form-horizontal"> <div class="col-md-9"> <div class="img-container"> <img id="SCREENSHOT_IMG" src="/downloadData/img?filePath=" alt="请选择图片"> </div> </div> <div class="col-md-3"> <div class="col-md-12 docs-buttons"> <div class="btn-group"> <label class="btn btn-primary btn-upload" for="SCREENSHOT_FILE" style="background-color: white; border-color: white; color: #2D79AB; font-size: 50px;"> <input type="file" class="sr-only" id="SCREENSHOT_FILE" name="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff"> <span class="docs-tooltip" data-toggle="tooltip" title="选择图片"> <span class="glyphicon glyphicon-open"></span> </span> </label> <button type="button" class="btn btn-primary" data-method="reset" style="background-color: white; border-color: white; color: #2D79AB; font-size: 50px; margin-left: 50px;"> <span class="docs-tooltip" data-toggle="tooltip" title="刷新"> <span class="glyphicons glyphicons-refresh"></span> </span> </button> </div> </div> <div class="docs-preview clearfix"> <div class="img-preview preview-lg"></div> <div class="img-preview preview-md"></div> <div class="img-preview preview-sm"></div> <div class="img-preview preview-xs"></div> </div> <div class="col-md-12 docs-buttons" style="margin-top: 20px;"> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="disable"> <span class="docs-tooltip" data-toggle="tooltip" title="锁定"> <span class="glyphicons glyphicons-lock"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="enable"> <span class="docs-tooltip" data-toggle="tooltip" title="解锁"> <span class="glyphicons glyphicons-unlock"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="crop"> <span class="docs-tooltip" data-toggle="tooltip" title="开启截图"> <span class="glyphicons glyphicons-ok_2"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="clear"> <span class="docs-tooltip" data-toggle="tooltip" title="关闭截图"> <span class="glyphicons glyphicons-remove_2"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="setDragMode" data-option="move"> <span class="docs-tooltip" data-toggle="tooltip" title="拖动"> <span class="glyphicons glyphicons-move"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="setDragMode" data-option="crop"> <span class="docs-tooltip" data-toggle="tooltip" title="裁剪"> <span class="fa fa-cut"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="zoom" data-option="0.1"> <span class="docs-tooltip" data-toggle="tooltip" title="放大"> <span class="glyphicon glyphicon-zoom-in"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="zoom" data-option="-0.1"> <span class="docs-tooltip" data-toggle="tooltip" title="缩小"> <span class="glyphicons glyphicons-zoom_out"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="rotate" data-option="-45"> <span class="docs-tooltip" data-toggle="tooltip" title="向左旋转"> <span class="fa fa-rotate-left"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="rotate" data-option="45"> <span class="docs-tooltip" data-toggle="tooltip" title="向右旋转"> <span class="fa fa-rotate-right"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="scaleX" data-option="-1"> <span class="docs-tooltip" data-toggle="tooltip" title="水平反射"> <span class="glyphicon glyphicon-resize-horizontal"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="scaleY" data-option="-1"> <span class="docs-tooltip" data-toggle="tooltip" title="垂直反射"> <span class="glyphicon glyphicon-resize-vertical"></span> </span> </button> </div> <div class="btn-group"> <button type="button" class="btn btn-primary" data-method="move" data-option="-10" data-second-option="0"> <span class="docs-tooltip" data-toggle="tooltip" title="向左移动"> <span class="glyphicon glyphicon-arrow-left"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="move" data-option="10" data-second-option="0"> <span class="docs-tooltip" data-toggle="tooltip" title="向右移动"> <span class="glyphicon glyphicon-arrow-right"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="move" data-option="0" data-second-option="-10"> <span class="docs-tooltip" data-toggle="tooltip" title="向上移动"> <span class="glyphicon glyphicon-arrow-up"></span> </span> </button> <button type="button" class="btn btn-primary" data-method="move" data-option="0" data-second-option="10"> <span class="docs-tooltip" data-toggle="tooltip" title="向下移动"> <span class="glyphicon glyphicon-arrow-down"></span> </span> </button> </div> </div> </div> </div>'
	},
	/**
	 * 初始化页面的数据，集成增删查改
