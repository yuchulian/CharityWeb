			...
			button : {
				"submit" : {
					...
					click : function(dataMap) {
						if(/^\/Download\//.test(util.temp.$SCREENSHOT_IMG.attr("src"))) {
							util.alert("请选择图片");
							return;
						}
						setTimeout(function() {
