...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,iframeJsUrl: URL + 'themes/default/iframe.js' //给编辑区域的iframe引入一个js文件
		...
		,whitList: {
			...
			a:      ['target', 'href', 'title', 'class', 'style', 'width', 'height'],
